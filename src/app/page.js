      ...
      <div className="text-center">
        <div className="flex flex-col space-y-10 items-center">
          <div className="flex items-center space-x-2">
            <div className="bg-[#FFFFFF] p-3 rounded-full shadow-md">
              <svg
                className="w-8 h-8 text-[#6A11CB]"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
            ...
            <div className="flex space-between">
              <h1 className="text-4xl font-bold text-gray-100 tracking-wider">
                <span className="text-[#FFD700]">Made By </span>
                <span className="text-gray-100">Umang Goyal</span>
              </h1>
            </div>
          </div>
          <div>
            <div className="flex flex-col md:flex-row space-y-5 md:space-y-0 space-x-0 md:space-x-10">
              <Link
                ...
                style={{
                  boxShadow: "5px 5px 15px rgba(0, 0, 0, 0.1), -5px -5px 15px rgba(255, 255, 255, 0.2)",
                }}
              >
                Face Detection
              </Link>
